  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        {errorCode && (
          <div className="pt-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900/60 font-mono text-[11px] font-semibold text-rose-700 dark:text-rose-300">
              <span>Error: [{errorCode}]</span>
              {statusCode && <span className="opacity-70">(HTTP {statusCode})</span>}
            </span>
          </div>
        )}
      </div>
